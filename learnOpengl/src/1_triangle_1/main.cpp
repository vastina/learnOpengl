...
void check1(unsigned int shader) {
	int  success;
	char infoLog[512];
...
void check2(unsigned int shader_program) {
	int  success;
	char infoLog[512];
...
int main(void) {
	...
	GLFWwindow* w = glfwCreateWindow(1000, 700, "w", NULL, NULL);
