...
int main() {
	...
	Shader shader("C:/Users/vastina/Desktop/learnOpengl/learnOpengl/src/7_camera/shader/vertex.glsl",
		"C:/Users/vastina/Desktop/learnOpengl/learnOpengl/src/7_camera/shader/frag.glsl");
    ...
    //glm::mat4 view = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.0, -4.0f));
